...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white px-4 md:px-8 py-4 flex items-center justify-between font-sans" data-aos="fade-down" data-aos-duration="3000">
      ...
      >
       <Link href="/"> <li className="px-4 py-2 md:p-0 text-center  md:text-left hover:text-gray-600">
        ...
        <Link href="/prodects"><li className="px-4 py-2 md:p-0 text-center md:text-left hover:text-gray-600">
          Shop
        </li> </Link>
        <Link href="/styles"> <li className="px-4 py-2 md:p-0 text-center md:text-left hover:text-gray-600">
          On Sale
        </li> </Link>
        <Link href="/"> <li className="px-4 py-2 md:p-0 text-center md:text-left hover:text-gray-600">
          Brands
