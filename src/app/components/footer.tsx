...
import payment from "../images/img.png"
import Link from 'next/link';

const Footer = () => {
  return (
    <><footer className="bg-gray-100 py-8 font-sans " data-aos="fade-up"
    data-aos-duration="3000">
      ...
      <footer className="text-gray-600 body-font font-sans bg-white">
              <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                  ...
                  <Link href="https://www.facebook.com/Arain.Boyz380?mibextid=ZbWKwL" className="ml-3 text-gray-500">
                  <svg
                              fill="currentColor"
                              strokeLinecap="round"
                      ...
                      <Link href="https://x.com/SikandarTahir23?s=09" className="ml-3 text-gray-500">
                          <svg
                              fill="currentColor"
                              strokeLinecap="round"
                              strokeLinejoin="round"
                      ...
                      <Link href="https://www.instagram.com/mrr_sikki?igsh=MTBzMnVhMjB0MmZiMg==" className="ml-3 text-gray-500">
                          <svg
                              fill="none"
                              stroke="currentColor"
                              strokeLinecap="round"
                      ...
                      <Link href="https://www.linkedin.com/in/sikandar-tahir-356a56273/" className="ml-3 text-gray-500">
                          <svg
                              fill="currentColor"
                              stroke="currentColor"
                              strokeLinecap="round"
